    ...
    execute: async (interaction) => {
        ...
        if (amount.toUpperCase() == "ALL") {
            ...
            if (randomChance < 0.5) {
                ...
                return interaction.reply(
                    `LMAOOO IMAGINE LOSING THAT MUCH MONEY LLLL. ¥${all} **YunBucks** was taken from your wallet`
                );
            }

            addToWallet(userID, all);
            return interaction.reply(
                `AYYY YOU WON!!! ¥${all} **YunBucks** was added into your wallet`
            );
        }
        ...
        if (randomChance < 0.5) {
            ...
            return interaction.reply(
                `LMAOOO IMAGINE LOSING THAT MUCH MONEY LLLL. ¥${amountNumber} **YunBucks** was taken from your wallet`
            );
        }

        addToWallet(userID, amountNumber);
        return interaction.reply(
            `AYYY YOU WON!!! ¥${amountNumber} **YunBucks** was added into your wallet`
        );
    },
    cooldown: 10,
};
