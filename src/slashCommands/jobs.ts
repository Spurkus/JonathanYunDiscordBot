...
const game = (thingy: string, disable: boolean) => {
    const embed = new EmbedBuilder()
        ...
        .setDescription(
            `Here is a list of jobs that you can do. Search powered by the Sex Algorithm:tm:`
        )
        .setColor("White")
        .setThumbnail(
            "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExa2M3ZWxzMTE1ZTRzYzAxOTQ1dDlnYXlwbHB5Nmh0Zmo1eTR5ZHpsbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2zUn8hAwJwG4abiS0p/giphy.gif"
        );
    ...
    execute: async (interaction) => {
        ...
        collector?.on("end", async () => {
            ...
            await interaction.followUp({
                content: `Your current job is **${Array.from(jobs.keys())[curJob - 1]}**`,
            });
        });
    },
    cooldown: 5,
